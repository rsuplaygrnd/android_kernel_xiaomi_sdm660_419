		...
		struct kobj_attribute *attr, char *buf)
{
	return snprintf(buf, PAGE_SIZE, "%d %d\n",
		snd_soc_component_read32(sound_control_component_ptr, MSM89XX_CDC_CORE_RX1_VOL_CTL_B2_CTL),
		snd_soc_component_read32(sound_control_component_ptr, MSM89XX_CDC_CORE_RX2_VOL_CTL_B2_CTL)
	);
}
		...
		struct kobj_attribute *attr, const char *buf, size_t count)
{
	...
	snd_soc_component_write(sound_control_component_ptr, MSM89XX_CDC_CORE_RX1_VOL_CTL_B2_CTL, input_l);
	snd_soc_component_write(sound_control_component_ptr, MSM89XX_CDC_CORE_RX2_VOL_CTL_B2_CTL, input_r);
		...
		struct kobj_attribute *attr, char *buf)
{
	return snprintf(buf, PAGE_SIZE, "%d\n",
		snd_soc_component_read32(sound_control_component_ptr, MSM89XX_CDC_CORE_RX3_VOL_CTL_B2_CTL)
	);
}
		...
		struct kobj_attribute *attr, const char *buf, size_t count)
{
	int input;
 	...
 	if (input < -10 || input > 20)
		input = 0;
 	snd_soc_component_write(sound_control_component_ptr, MSM89XX_CDC_CORE_RX3_VOL_CTL_B2_CTL, input);
 	return count;
}
...
{
	return snprintf(buf, PAGE_SIZE, "%d\n",
		snd_soc_component_read32(sound_control_component_ptr, MSM89XX_CDC_CORE_TX1_VOL_CTL_GAIN),
		snd_soc_component_read32(sound_control_component_ptr, MSM89XX_CDC_CORE_TX2_VOL_CTL_GAIN)
	);
}
		...
		struct kobj_attribute *attr, const char *buf, size_t count)
{
	int input;
 	...
 	if (input < -10 || input > 20)
		input = 0;
 	snd_soc_component_write(sound_control_component_ptr, MSM89XX_CDC_CORE_TX1_VOL_CTL_GAIN, input);
 	snd_soc_component_write(sound_control_component_ptr, MSM89XX_CDC_CORE_TX2_VOL_CTL_GAIN, input);
 	return count;
}
